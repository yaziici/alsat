            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="uye-ekle.php"><button class="btn btn-primary btn-sm">Üye Ekle</button></a>                  
                  ...
                  <div class="table-responsive ps ps--theme_default" data-ps-id="1c05b7b3-d04f-70fa-e18b-35ba99c5bdd4">
                    <table class="table center-aligned-table">
                      <thead>
                        <tr>
                          <th style="width: 20%; color:red; text-align: center;">Üye ID</th>
                      ...
                      <tbody>
                        ...
                        <tr class="">
                          <td style="text-align: center;"><?php echo $uyecek['uye_id'];?></td>
