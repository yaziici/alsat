...
<?php 
                        ...
                        <div class="card-body">                          
                          <ul class="nav nav-tabs" id="Demo-tab1" role="tablist">
                              ...
                              <li class="nav-item">
                                  <a class="nav-link" data-toggle="tab" href="#İletişim" role="tab" aria-expanded="false">İletişim</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" data-toggle="tab" href="#Google" role="tab" aria-expanded="false">Google</a>
                              </li>                              
                          </ul>
                          ...
                          <div class="tab-content">
                              ...
                              <div class="tab-pane pt-4" id="İletişim" role="tabpanel" aria-expanded="false">
                                <form name="ayar_iletisim" action="islem.php" method="POST">
                    <div class="form-group">
                      <label>Telefon Numarası</label>
                      <input class="form-control" type="text" name="ayar_tel" value="<?php echo $ayarcek ['ayar_tel']; ?> "/>
                    </div>
                    <div class="form-group">
                    ...
                    <input class="btn btn-success" style="width: 100%" type="submit" name="ayar_iletisim" value="Ayarları Kaydet"/>
                    </form>
                              ...
                              <div class="tab-pane pt-4" id="Google" role="tabpanel" aria-expanded="false">
                                <form name="ayar_google" action="islem.php" method="POST">
                                <div class="form-group">
                    ...
                    <input class="btn btn-success" style="width: 100%" type="submit" name="ayar_google" value="Ayarları Kaydet"/>
                  </form>
                              </div>
                          </div>
                      </div>
