...
<div class="panel-body">
<div class="row">
  <div class="col-md-10"><strong><?php echo $_POST['aranan']; ?> </strong> Aramanızda bulunan ilanlar aşağıdadır.<br>
  </div>
  <div class="col-md-2">
...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"> <a href="#">Arama</a></li>
</ul>
<br />
  ...
  <tbody>
    ...
    <?php 
          if(empty($_POST['$aranan'])){
               ...
               $aranan=$_POST['aranan'];
                $aramasor=mysqli_query($con, "SELECT * FROM urunler WHERE urun_ad LIKE '%$aranan' "); 
                              $sql=mysqli_query($con,$aramasor);
                              while($aramacek=mysqli_fetch_assoc($sql)){ ?>


          <tr class="ilanlar" data-id="ilandetay.php?urun_id=<?php echo $aramacek['urun_id'];?>&urun_kulid=<?php echo $aramacek['urun_kulid'];?>">
                <td style="padding:0px !important"><center>
                    <img src="alsatadmin/<?php echo $aramacek['urun_foto']; ?>" width="100" height="100" class="img-responsive" style="max-height:100px">
                  </center></td>
                <td><?php echo $aramacek['urun_ad']; ?></td>
                <td class="center fiyat"><?php echo $aramacek['urun_fiyat']; ?> TL</td>
                <td class="center"><?php echo $aramacek['urun_ilantarih']; ?></td>
                 <td class="center"><?php echo $aramacek['urun_il']; ?><br><?php echo $aramacek['urun_ilce']; ?></td>
              </tr>
